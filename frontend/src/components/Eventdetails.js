...
class Eventdetails extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("http://localhost:4000/project-overview/geteventusers/" + data.id)
      .then((response) => {
  ...
  render() {
      ...
      displayform = (
        <div class="paddingleft15">
          <div class="form-group row" paddingleft>
            <div class="col-lg-10" style={{ marginTop: "20px" }}>
              <h2> USERS ASSIGNED TO THIS EVENT</h2>{" "}
            </div>
          </div>
    ...
    return <div style={{ paddingLeft: "150px" }}>{displayform}</div>;
  }
}
