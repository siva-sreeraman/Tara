...
import { TextField, Button, DialogTitle, Dialog, DialogContent } from "@material-ui/core";
  ...
  render() {
    ...
    if (this.state.usercheck) {
      const formdetails = this.state.userdetails.map((userdetails) => {
        ...
        projectmodel = <Dialog open={this.state.projectshow} aria-labelledby="customized-dialog-title" onClose={this.handleprojectclose}>
