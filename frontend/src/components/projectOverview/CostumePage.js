...
this.getcostumes();
  ...
  axios.get(Env.host + "/project-overview/getprojectcostumes/"+this.state.projectid)
  .then((response) => {
    console.log(response);
...
this.setState({
   ...
   SubmitCreateCostumes = () =>
  {
    ...
    console.log(data)
    axios.post(Env.host + "/companydb/submitnewcostumebyproject/",data).then((response) => {
      console.log(response);
...
await axios.post(Env.host + "/project-overview/addcostumes_toproject",data).then((response) => {
  console.log(response);
...
this.setState({
  ...
  render() {
    ...
    costumecreate= <Modal show={this.state.showmodal} onHide={this.handleprojectclose}>
 ...
 costumemodal =  <Modal show={this.state.costumeshow} onHide={this.handleprojectclose}>
 <Modal.Header closeButton>
   <Modal.Title>Add Costumes</Modal.Title>
 </Modal.Header>
 <Modal.Body>
