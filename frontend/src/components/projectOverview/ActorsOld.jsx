...
const columns = [
  ...
  { id: "actor", label: "Actor", minWidth: 170 },
  { id: "contact", label: "Contact", minWidth: 100 },
];

function createData(index, actor, contact) {
  return { index, actor, contact };
}

const rows = [
  createData(1, "Josh Brolin", "3456789"),
  createData(2, "Chadwick", "3456789"),
...
export default function Actors() {
  ...
  return (
    <div>
      ...
      <button className="btn btn-outline-primary">Add Actor</button>
